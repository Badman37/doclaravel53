...
<article>
    ...
    <ul>
        ...
        <li><a href="#configuration">Configuration</a>
            <ul>
                <li><a href="#the-public-disk">The Public Disk</a>
                </li>
                <li><a href="#the-local-driver">The Local Driver</a>
                </li>
        ...
        <li><a href="#retrieving-files">Retrieving Files</a>
            <ul>
                <li><a href="#file-urls">File URLs</a>
                </li>
                <li><a href="#file-metadata">File Metadata</a>
                </li>
            </ul>
        </li>
        <li><a href="#storing-files">Storing Files</a>
            <ul>
                ...
                <li><a href="#file-visibility">File Visibility</a>
                </li>
            </ul>
        </li>
        ...
        <li><a href="#custom-filesystems">Custom Filesystems</a>
        </li>
    </ul>
    <p>
    ...
    <ul>
        <li>Amazon S3: <code class=" language-php">league<span class="token operator">/</span>flysystem<span class="token operator">-</span>aws<span class="token operator">-</span>s3<span class="token operator">-</span>v3 <span class="token operator">~</span><span class="token number">1.0</span></code>
        </li>
        <li>Rackspace: <code class=" language-php">league<span class="token operator">/</span>flysystem<span class="token operator">-</span>rackspace <span class="token operator">~</span><span class="token number">1.0</span></code>
        </li>
    </ul>
    <h4>S3 Driver Configuration</h4>
    <p>The S3 driver configuration information is located in your <code class=" language-php">config<span class="token operator">/</span>filesystems<span class="token punctuation">.</span>php</code> configuration file. This file contains an example configuration array for an S3 driver. You are free to modify this array with your own S3 configuration and credentials.</p>
...
<span class="token scope">Storage<span class="token punctuation">::</span></span><span class="token function">put<span class="token punctuation">(</span></span><span class="token string">'avatars/1'</span><span class="token punctuation">,</span> <span class="token variable">$fileContents</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code></pre>
    ...
    <h3>File URLs</h3>
    <p>When using the <code class=" language-php">local</code> or <code class=" language-php">s3</code> drivers, you may use the <code class=" language-php">url</code> method to get the URL for the given file. If you are using the <code class=" language-php">local</code> driver, this will typically just prepend <code class=" language-php"><span class="token operator">/</span>storage</code> to the given path and return a relative URL to the file. If you are using the <code class=" language-php">s3</code> driver, the fully qualified remote URL will be returned:</p>
    <pre class=" language-php"><code class=" language-php"><span class="token keyword">use</span> <span class="token package">Illuminate<span class="token punctuation">\</span>Support<span class="token punctuation">\</span>Facades<span class="token punctuation">\</span>Storage</span><span class="token punctuation">;</span>

<span class="token variable">$url</span> <span class="token operator">=</span> <span class="token scope">Storage<span class="token punctuation">::</span></span><span class="token function">url<span class="token punctuation">(</span></span><span class="token string">'file1.jpg'</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code></pre>
    <blockquote class="has-icon note">
        <p>
            ...
            </div> Remember, if you are using the <code class=" language-php">local</code> driver, all files that should be publicly accessible should be placed in the <code class=" language-php">storage<span class="token operator">/</span>app<span class="token operator">/</span><span class="token keyword">public</span></code> directory. Furthermore, you should <a href="#the-public-disk">create a symbolic link</a> to the <code class=" language-php">storage<span class="token operator">/</span>app<span class="token operator">/</span><span class="token keyword">public</span></code> directory.</p>
    </blockquote>
    <p>
...
// Manually specify a file name...
    ...
    <p>There are a few important things to note about the <code class=" language-php">putFile</code> method. Note that we only specified a directory name, not a file name. By default, the <code class=" language-php">putFile</code> method will automatically generate a filename based on the contents of the file. This is accomplished by taking a MD5 hash of the file's contents. The path to the file will be returned by the <code class=" language-php">putFile</code> method so you can store the path, including the generated file name, in your database.</p>
    <p>The <code class=" language-php">putFile</code> and <code class=" language-php">putFileAs</code> methods also accept an argument to specify the "visibility" of the stored file. This is particularly useful if you are storing the file on a cloud disk such as S3 and would like the file to publicly accessible:</p>
...
<span class="token scope">Storage<span class="token punctuation">::</span></span><span class="token function">append<span class="token punctuation">(</span></span><span class="token string">'file.log'</span><span class="token punctuation">,</span> <span class="token string">'Appended Text'</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code></pre>
    ...
    <pre class=" language-php"><code class=" language-php"><span class="token scope">Storage<span class="token punctuation">::</span></span><span class="token function">copy<span class="token punctuation">(</span></span><span class="token string">'old/file1.jpg'</span><span class="token punctuation">,</span> <span class="token string">'new/file1.jpg'</span><span class="token punctuation">)</span><span class="token punctuation">;</span>

<span class="token scope">Storage<span class="token punctuation">::</span></span><span class="token function">move<span class="token punctuation">(</span></span><span class="token string">'old/file1.jpg'</span><span class="token punctuation">,</span> <span class="token string">'new/file1.jpg'</span><span class="token punctuation">)</span><span class="token punctuation">;</span></code></pre>
    <p>
        <a name="file-uploads"></a>
    </p>
    <h3>File Uploads</h3>
    <p>In web applications, one of the most common use-cases for storing files is storing user uploaded files such as profile pictures, photos, and documents. Laravel makes it very easy to store uploaded files using the <code class=" language-php">store</code> method on an uploaded file instance. Simply call the <code class=" language-php">store</code> method with the path at which you wish to store the uploaded file:</p>
...
<span class="token punctuation">}</span></code></pre>
    <p>There are a few important things to note about this example. Note that we only specified a directory name, not a file name. By default, the <code class=" language-php">store</code> method will automatically generate a filename based on the contents of the file. This is accomplished by taking a MD5 hash of the file's contents. The path to the file will be returned by the <code class=" language-php">store</code> method so you can store the path, including the generated file name, in your database.</p>
    ...
    <blockquote class="has-icon note">
        <p>
            <div class="flag"><span class="svg"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" version="1.1" x="0px" y="0px" width="90px" height="90px" viewBox="0 0 90 90" enable-background="new 0 0 90 90" xml:space="preserve"><path fill="#FFFFFF" d="M45 0C20.1 0 0 20.1 0 45s20.1 45 45 45 45-20.1 45-45S69.9 0 45 0zM45 74.5c-3.6 0-6.5-2.9-6.5-6.5s2.9-6.5 6.5-6.5 6.5 2.9 6.5 6.5S48.6 74.5 45 74.5zM52.1 23.9l-2.5 29.6c0 2.5-2.1 4.6-4.6 4.6 -2.5 0-4.6-2.1-4.6-4.6l-2.5-29.6c-0.1-0.4-0.1-0.7-0.1-1.1 0-4 3.2-7.2 7.2-7.2 4 0 7.2 3.2 7.2 7.2C52.2 23.1 52.2 23.5 52.1 23.9z"></path></svg></span>
            </div> If you are receiving very large file uploads, you may wish to manually specify the file name as shown below. Calculating an MD5 hash for extremely large files can be memory intensive.</p>
    </blockquote>
...
<span class="token punctuation">}</span></code></pre>
    ...
    <p>Once you have created the service provider to register the extension, you may use the <code class=" language-php">dropbox</code> driver in your <code class=" language-php">config<span class="token operator">/</span>filesystem<span class="token punctuation">.</span>php</code> configuration file.</p>
    <div>Nguồn: <a href="https://laravel.com/docs/5.3/filesystem">https://laravel.com/docs/5.3/filesystem</a></div>
</article>
@endsection