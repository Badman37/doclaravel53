...
<article>
    <h1>Routing</h1>
    <ul>
        <li><a href="#basic-routing">Cơ bản routing</a>
        </li>
        <li><a href="#route-parameters">Các tham số route</a>
            <ul>
                <li><a href="#required-parameters">Tham số bắt buộc</a>
                </li>
                <li><a href="#parameters-optional-parameters">Tham số tùy chọn</a>
                </li>
            </ul>
        </li>
        <li><a href="#named-routes">Tên routes</a>
        </li>
        <li><a href="#route-groups">Nhóm route</a>
            <ul>
                <li><a href="#route-group-middleware">Middleware</a>
                </li>
                <li><a href="#route-group-namespaces">Namespace</a>
                </li>
                <li><a href="#route-group-sub-domain-routing">Routing tên miền con</a>
                </li>
                <li><a href="#route-group-prefixes">Tiền tố route</a>
                </li>
            </ul>
        </li>
        <li><a href="#route-model-binding">Route Model Binding</a>
            <ul>
                <li><a href="#implicit-binding">Implicit Binding</a>
                </li>
                <li><a href="#explicit-binding">Explicit Binding</a>
                </li>
            </ul>
        </li>
        <li><a href="#form-method-spoofing">Form Method Spoofing</a>
        </li>
        <li><a href="#accessing-the-current-route">Truy cập route hiện tại</a>
        </li>
    </ul>
    <p>
...
Route::any('foo', function () {
    ...
    <h4>Bảo mật CSRF</h4>
    <p>Tất cả các HTML form có method là <code>POST</code>, <code>PUT</code>, hoặc <code>DELETE</code> đều chỉ đến routes được định nghĩa trong middlware <code>web</code> thì cần được thêm trường CSRF token. Nếu không thì request sẽ bị từ trối. Bạn có thể đọc thêm về bảo mật CSRF tại <a href="{{URL::asset('')}}docs/5.3/csrf">Tài liệu CSRF</a>:</p>
...
Route::get('user/{name?}', function ($name = 'John') {
    ...
    <pre><code>Route::get('user/profile', <a class="__cf_email__" href="/cdn-cgi/l/email-protection" data-cfemail="e4c3b1978196a78b8a90968b88888196a4978c8b93b4968b828d8881">[email&#160;protected]</a><script data-cfhash='f9e31' type="text/javascript">/* <![CDATA[ */!function(t,e,r,n,c,a,p){try{t=document.currentScript||function(){for(t=document.getElementsByTagName('script'),e=t.length;e--;)if(t[e].getAttribute('data-cfhash'))return t[e]}();if(t&&(c=t.previousSibling)){p=t.parentNode;if(a=c.getAttribute('data-cfemail')){for(e='',r='0x'+a.substr(0,2)|0,n=2;a.length-n;n+=2)e+='%'+('0'+('0x'+a.substr(n,2)^r).toString(16)).slice(-2);p.replaceChild(document.createTextNode(decodeURIComponent(e)),c)}p.removeChild(t)}}catch(u){}}()/* ]]> */</script>')-&gt;name('profile');</code></pre>
...
$action = Route::currentRouteAction();</code></pre>
    ...
    <div>Nguồn: <a href="https://laravel.com/docs/5.3/routing">https://laravel.com/docs/5.3/routing</a></div>
</article>
@endsection